...
#the top four countries in the past three Olympics. Assign the value of Great Britain’s
#gold medal count from the London Olympics to the variable london_gold. Use indexing. Do not hardcode.
...
#Iterate through the contents of l_of_l and assign the third element of sublist to a
#new list called third.
...
#name if it contains the letter “t”. If it does not contain the letter “t”,
