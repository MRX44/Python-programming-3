...
#Use filter to produce a list called b_countries that only contains
#the strings from countries that begin with B.
...
#Below, we have provided a list of tuples that contain the names of
#Game of Thrones characters. Using list comprehension, create a list of strings
#called first_names that contains only the first names of everyone in the
#original list.
people = [('Snow', 'Jon'), ('Lannister', 'Cersei'), ('Stark', 'Arya'), ('Stark', 'Robb'), ('Lannister', 'Jamie'), ('Targaryen', 'Daenerys'), ('Stark', 'Sansa'), ('Tyrell', 'Margaery'), ('Stark', 'Eddard'), ('Lannister', 'Tyrion'), ('Baratheon', 'Joffrey'), ('Bolton', 'Ramsey'), ('Baelish', 'Peter')]
first_names = [j for i,j in people]
...
#element in the list, ls
lst = [["hi", "bye"], "hello", "goodbye", [9, 2], 4]
lst2 = [var*2 for var in lst]
...
#and their final grades in PYTHON 101. Using list comprehension,
...
endangered = [sp for sp , po in pop_info if po <2500]
